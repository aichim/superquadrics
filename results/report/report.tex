...
The arclength between two close points on such a curve is $x(\theta)$ and $x (\theta + \Delta_\theta (\theta))$ and can be approximated by the euclidean distance between the points:
